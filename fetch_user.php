...
$query = "SELECT * FROM login WHERE user_id != '".$_SESSION['user_id']."' ORDER BY user_id DESC";
$query2 = "SELECT * FROM chat_message WHERE to_user_id = ".$_SESSION['user_id']." ORDER BY timestamp DESC";
